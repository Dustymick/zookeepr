...
//second GET route added. Used req.params, therefore, :id was added to the end of the route. Also, param route must come after the other GET route//
...
//post route added. client is sending data to server//
